    ...
    <div class="d-flex">
        <h1 class="ps-3 me-auto">{{ $ticket->title }}
            @switch($ticket->priority)
                @case(0)
                    <span class="badge bg-info fs-6">Alacsony</span>
                    @break
                @case(1)
                    <span class="badge bg-success fs-6">Normál</span>
                    @break
                @case(2)
                    <span class="badge bg-warning fs-6">Magas</span>
                    @break
                @case(3)
                    <span class="badge bg-danger text-white fs-6">Azonnal</span>
                    @break
            @endswitch
        </h1>
