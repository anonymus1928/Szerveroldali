                ...
                <tr class="@if($ticket->priority == 3) table-danger @elseif($ticket->priority == 2) table-warning @endif">
                    <td>
                        @switch($ticket->priority)
                            @case(0)
                                <span class="badge rounded-pill bg-info fs-6 text-black">Alacsony</span>
                                @break
                            @case(1)
                    ...
                    <td>
                        <span class="badge rounded-pill bg-info text-dark fs-6">@if($ticket->done) Lezárva @elseif($ticket->comments->count() === 1) Új @else Folyamatban @endif</span>
                    </td>
                    <td>
                        <a href="{{ route('tickets.show', ['ticket' => $ticket->id]) }}" class="btn btn-outline-secondary">
